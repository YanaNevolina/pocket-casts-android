...
Onboarding instrumentation tests can read credentials from `onboarding-test.local.properties`, environment variables, or Gradle properties.

For local runs:

1. Create `onboarding-test.local.properties` from the template:
...
See [Onboarding E2E tests guide](docs/testing/onboarding-e2e.md) for full setup and CI details.
